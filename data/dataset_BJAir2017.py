...
class BJAir2017(BaseDataset):
    def __init__(self, opt, mode='train'):
        ...
        # location_path = 'bjair2017/stations.csv'
        # data_path = 'bjair2017/raw_data.csv'
        # meta_path = 'bjair2017/meta_data.pkl'
        # test_nodes_path = 'bjair2017/test_nodes.npy'
        ...
        # self.drop_attrs += ['PM25_Missing','PM10_Missing', 'NO2_Missing', 'O3_Missing', 'CO_Missing', 'SO2_Missing']
        self.pred_attrs = [opt.pred_attr]
